...
<?php
        ...
        if(isset($_POST['cari'])){
            ...
            if($crud->cari($kata_kunci)){
                
                 echo "<script>alert('SUKSES Cari')</script>";
                }
        }
        ...
        <div class="container">
            ...
            <form action="cari.php" method="post">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                    <input type="text" class="form-control" size="50" style="height:55px" placeholder="Cari pekerjaan anda" name="kata_kunci" >
                    </li>
