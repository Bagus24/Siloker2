        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li>
                    <input type="text" class="form-control" size="50" style="height:55px" placeholder="Cari pekerjaan anda" id="query" name="search" >
                    </li>
                
                    <li>&nbsp&nbsp&nbsp<button type="submit" class="btn btn-primary" style="height:55px" id="search"><span class="glyphicon glyphicon-search" ></span>&nbspCari</button></li>
...
<div class="col-lg-8 well col-lg-offset-3" style="top:150px;background:white;font-family:Helvetica">
    ...
    <button type = "submit" class = "btn btn-primary" name="simpan"><span class="glyphicon glyphicon-pencil"></span></button>
    </div>
        <div style="text-align:center">
        <?php
            ...
            $query = "SELECT * FROM registration WHERE nama=:nama";
            $crud->gambar_profil($query);
